import { TimestampFormatterOptions } from 'stream-chat-react-native-core/lib/typescript/utils/i18n/types';
import { isDayOrMoment, TranslatorFunctions } from 'stream-chat-react-native';
